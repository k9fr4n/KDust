...
import { overwriteCategoryEverywhere } from '@/lib/audit/provision';

export const runtime = 'nodejs';

/**
 * POST /api/audits/defaults/:id/overwrite
 *
 ...
 *
 * Also useful to rebuild the prompt of legacy audit tasks that were
