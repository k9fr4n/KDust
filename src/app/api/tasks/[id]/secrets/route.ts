// src/app/api/tasks/[id]/secrets/route.ts
//
// TaskSecret bindings for a given task (Franck 2026-04-21 21:45).
//   GET  /api/tasks/:id/secrets  - list bindings (env -> secret name)
//   POST /api/tasks/:id/secrets  - upsert a single binding
//
// DELETE lives at /api/tasks/:id/secrets/:envName.
