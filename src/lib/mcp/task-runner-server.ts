...
// Modular helpers (refactor: lib-modular-split, 2026-04-29).
// resolveB2B3 is re-exported below to keep its single existing
// importer (src/lib/mcp/registry.ts in chat-mode dispatch path)
// working unchanged.
import { MAX_DEPTH } from './task-runner/constants';
import { resolveTaskForProject } from './task-runner/resolve-task';
...
// MAX_DEPTH and resolveTaskForProject now live in
// ./task-runner/constants.ts and ./task-runner/resolve-task.ts.
