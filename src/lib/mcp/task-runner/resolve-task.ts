...
/**
 * Resolve a task reference (id or name) for the enqueue_followup
 * tool (ADR-0008 decoupled-chain model).
 *
 ...
 *      If both a project-bound AND a generic task share the same
 *      name, the PROJECT-BOUND one wins (more specific → less
 *      surprising).
 *
